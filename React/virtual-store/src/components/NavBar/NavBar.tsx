  ...
  return (
    <header className="h-[150px] bg-[#ff3b3c] pt-5 pb-0 px-5 flex flex-col items-center">
      <div className="w-[1080px] flex justify-between items-center flex-grow">
        <Link to="/" className="w-1/3 flex items-center flex-grow justify-start">
          <img
        ...
        <ul className="w-1/3 flex items-center flex-grow justify-end list-none">
          <li id="facebook" className="h-[50px] w-[50px]">
            <a className="h-[50px] w-[50px]" href="https://facebook.com">
              <img
                className="h-[50px] w-[50px] p-2.5"
          ...
          <li id="instagram" className="h-[50px] w-[50px]">
            <a className="h-[50px] w-[50px]" href="https://instagram.com">
              <img
                className="h-[50px] w-[50px] p-2.5"
          ...
          <li id="cart" className="h-[50px] w-[50px]">
      ...
      <nav id="navbar" className="w-[1080px] p-3.5 px-5 bg-[#ff3b3c] flex justify-between list-none text-base">
